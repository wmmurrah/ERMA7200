...
advdate <- function(obj, adv) {
  ...
  tmp <- paste("Week ",zadv,", Wednesday "," ", tmon, sep = '')
  return(tmp)
}
...
# library(rcrossref)
bib <- ReadBib("products/syllabus/ref-link.bib")
myopts <- BibOptions(bib.style = "authoryear", first.inits=TRUE, max.names = 20)
