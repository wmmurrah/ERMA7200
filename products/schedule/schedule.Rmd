...
##  `r advdate(mon, 6)`: Non-Experimental Research
...
* Quiz 1 Assigned (Due in 2 weeks)
* Homework 2 Due
...
##  `r advdate(mon, 8)`: Qualitative and Mixed Methods Designs



### Readings

* Okasha Chapters 5 and 6

### Assignments

* Homework 3 Due

##  `r advdate(mon, 9)`:  Interpreting Results
...
## `r advdate(mon, 10)`: Computational Methods
